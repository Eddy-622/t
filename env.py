...
USER_ACCOUNTS = [
    # 目前已支持仅查询，不下单，屏蔽掉下面的账号即可
    {
        ...
        'user_name': 'a451242175',
        'password': 'zzzsyzxl520',
        'type': '其他'  # qr 为扫码登录，填写其他为密码登录
    },
    # {
    #     'key': 'wangwu',
...
SERVERCHAN_KEY = 'SCT113834T8CS2UlaYTBc4ftTfbPOOoMd9'
PUSHBEAR_ENABLED = 0
PUSHBEAR_KEY = ''
...
EMAIL_SENDER = '451242175@qq.com'  # 邮件发送者
EMAIL_RECEIVER = ['451242175@qq.com', 'z451242175@gmail.com']  # 邮件接受者 # 可以多个 [email1@gmail.com, email2@gmail.com]
EMAIL_SERVER_HOST = 'smtp.qq.com'  # 邮件服务 host
EMAIL_SERVER_USER = '451242175@qq.com'  # 邮件服务登录用户名
EMAIL_SERVER_PASSWORD = 'nghckbzujybjbhcb'  # 邮件服务登录密码


# Web 管理
WEB_ENABLE = 0  # 是否打开 Web 管理
WEB_USER = {  # 登录信息
    'username': 'admin',
    'password': 'password'
}
